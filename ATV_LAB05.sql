...
SELECT d.cd_dvd, d.titulo, c.nm_categoria
...
FROM TB_DVD d INNER JOIN TB_ALUGUEL at
	 ON (at.cd_dvd = d.cd_dvd)

---------------------------------------------------

SELECT d.titulo, a.dt_devolucao
...
FROM TB_USUARIO u INNER JOIN TB_ALUGUEL a
