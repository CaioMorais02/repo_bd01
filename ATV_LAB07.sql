...
FROM TB_DEPARTAMENTO D LEFT OUTER JOIN TB_SETOR S
	 ON (D.CD_DEPARTAMENTO = S.CD_SETOR)
...
FROM TB_DEPARTAMENTO D LEFT OUTER JOIN TB_SETOR S
	 ...
	 LEFT OUTER JOIN TB_FUNCIONARIO F
...
SELECT COUNT(S.CD_SOLICITACAO) AS 'SOLICITAÇÕES POR FUNCIONÁRIO'
FROM TB_SOLICITACAO S INNER JOIN TB_FUNCIONARIO F
	 ON (S.MATRICULA = F.MATRICULA)

-------------------------------------------------------------------------------

SELECT COUNT(S.CD_SOLICITACAO) AS 'SOLICITAÇÕES POR SETOR'
FROM TB_SOLICITACAO S INNER JOIN TB_FUNCIONARIO F
	 ON (S.MATRICULA = F.MATRICULA)
...
SELECT COUNT(S.CD_SOLICITACAO) AS 'SOLICITAÇÕES POR DEPARTAMENTO'
FROM TB_SOLICITACAO S INNER JOIN TB_FUNCIONARIO F
	 ON (S.MATRICULA = F.MATRICULA)
	 INNER JOIN TB_SETOR SE
	 ON (F.CD_SETOR = SE.CD_SETOR)
...
SELECT COUNT(S.CD_SOLICITACAO) AS 'SOLICITAÇÕES EM POR DEPARTAMENTO'
FROM TB_SOLICITACAO S INNER JOIN TB_FUNCIONARIO F
	 ON (S.MATRICULA = F.MATRICULA)
	 INNER JOIN TB_SETOR SE
	 ON (F.CD_SETOR = SE.CD_SETOR)
	 INNER JOIN TB_DEPARTAMENTO D
	 ON (SE.CD_DEPARTAMENTO = D.CD_DEPARTAMENTO)
GROUP BY S.DATA_FECHAMENTO
HAVING COUNT(S.CD_SOLICITACAO) > 2 AND S.DATA_FECHAMENTO IS NULL

-------------------------------------------------------------------------------

SELECT T.NM_TECNICO, F.MATRICULA, F.NM_FUNCIONARIO, S.DATA_ABERTURA, S.DESCRICAO
FROM TB_TECNICO T INNER JOIN TB_SOLICITACAO S
	 ON (T.CD_TECNICO = S.CD_TECNICO)
	 INNER JOIN TB_FUNCIONARIO F
	 ON (S.MATRICULA = F.MATRICULA)
GROUP BY S.DATA_FECHAMENTO, T.NM_TECNICO, F.MATRICULA, F.NM_FUNCIONARIO, S.DATA_ABERTURA, S.DESCRICAO
HAVING S.DATA_FECHAMENTO IS NULL